...
printf "alpha?\t1\t1\t0.500\t-0.100\tc1\t1.200\tanswer a\tanswer a\n" >> "$summary_tsv"
printf "beta?\t1\t2\t-0.250\t0.300\tc2;c0\t0.900;0.800\t*bad;answer c\tplain bad;answer c\n" >> "$summary_tsv"
...
a2a_assert_grep "answer_kv_changed: 1/3" "$summary_out" "repl TSV summary reports answer KV contrast"
