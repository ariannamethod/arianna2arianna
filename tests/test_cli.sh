...
a2a_assert_grep "answer_quality: any 3/3, short 2, question_like 1, label_artifact 0, notation_artifact 1, morph_artifact 1, yes_no_start 1, repetition 1" "$summary_out" "repl TSV summary reports answer quality flags"
