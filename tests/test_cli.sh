...
a2a_assert_grep "answer_quality: any 3/3, short 2, question_like 1, label_artifact 0, notation_artifact 1, morph_artifact 1, recipient_artifact 0, yes_no_start 1, repetition 1" "$summary_out" "repl TSV summary reports answer quality flags"
...
rm -f "$junk_tsv"
a2a_assert_grep "answer_quality: any 3/3, short 0, question_like 0, label_artifact 0, notation_artifact 0, morph_artifact 3, recipient_artifact 0" "$junk_out" "repl TSV summary flags domain, assignment, and tail junk"
