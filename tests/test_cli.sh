...
printf "alpha?\t1\t1\t0.500\t-0.100\tc1\t1.200\tmemory holds here\tmemory holds here\n" >> "$summary_tsv"
printf "beta?\t1\t2\t-0.250\t0.300\tc2;c0\t0.900;0.800\t*bad;yes yes?\tplain bad;answer c\n" >> "$summary_tsv"
...
a2a_assert_grep "answer_quality: any 2/3, short 2, question_like 1, label_artifact 0, yes_no_start 1, repetition 1" "$summary_out" "repl TSV summary reports answer quality flags"
