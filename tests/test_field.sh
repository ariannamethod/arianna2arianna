...
if printf "%s\n" "$field_sweep_out" | awk -F '\t' '$1 == "Let the cells remember each other." && $16 ~ /^[0-9]+$/ && $17 ~ /^[0-9]+$/ && $18 ~ /^[0-9]+$/ && $19 ~ /^[0-9]+$/ && $20 ~ /^[0-9]+$/ && $21 ~ /^[0-9]+$/ && ($22 == "nan" || $22 ~ /^[0-9]+[.][0-9]+$/) && ($23 == "nan" || $23 ~ /^[0-9]+[.][0-9]+$/) && ($24 == "nan" || $24 ~ /^[0-9]+[.][0-9]+$/) && ($25 == "nan" || $25 ~ /^[0-9]+[.][0-9]+$/) && ($26 == "nan" || $26 ~ /^[0-9]+[.][0-9]+$/) && ($27 == "nan" || $27 ~ /^[0-9]+[.][0-9]+$/) && ($28 == "nan" || $28 ~ /^[0-9]+[.][0-9]+$/) && ($29 == "nan" || $29 ~ /^[0-9]+[.][0-9]+$/) && ($30 == "nan" || $30 ~ /^[0-9]+[.][0-9]+$/) && ($31 == "nan" || $31 ~ /^[0-9]+[.][0-9]+$/) && ($32 == "nan" || $32 ~ /^[+-]?[0-9]+[.][0-9]+$/) && $33 ~ /^[0-9]+$/ && $34 ~ /^[0-9]+$/ && $35 ~ /^[0-9]+$/ && $36 ~ /^[0-9]+$/ && $37 ~ /^[0-9]+$/ && $38 ~ /^[0-9]+$/ && $44 ~ /^[0-9]+$/ && ($45 == "nan" || $45 ~ /^[0-9]+[.][0-9]+$/) && $46 == 6 && $47 ~ /^[0-9]+$/ && ($53 == "nan" || $53 ~ /^[0-9]+[.][0-9]+$/) && ($54 == "nan" || $54 ~ /^[0-9]+$/) && $55 ~ /^[0-9]+$/ && $56 ~ /^[0-9]+$/ && $57 ~ /^[0-9]+$/ && $58 ~ /^[0-9]+$/ && $59 ~ /^[0-9]+$/ && ($60 == "nan" || $60 ~ /^[0-9]+$/) && $61 ~ /^[0-9]+$/ && $62 ~ /^[0-9]+$/ && $63 ~ /^[0-9]+$/ { ok = 1 } END { exit ok ? 0 : 1 }'; then
...
if printf "%s\n" "$field_grid_out" | awk -F '\t' 'NR == 1 && $1 == "xcell" { header = NF } NR > 1 && $1 == "0" { row = NF } END { exit (header == 60 && row == 60) ? 0 : 1 }'; then
